...
}:
{
  ...
  boot = {
    initrd = {
      ...
      kernelModules = [ ];
      luks.devices = {
        "luks-a927055e-2653-43cc-8010-ccf74a9d7577".device = "/dev/disk/by-uuid/a927055e-2653-43cc-8010-ccf74a9d7577";
        "luks-e7be9226-e962-45c1-93ef-7af8caabf4f3".device = "/dev/disk/by-uuid/e7be9226-e962-45c1-93ef-7af8caabf4f3";
      };
    };
